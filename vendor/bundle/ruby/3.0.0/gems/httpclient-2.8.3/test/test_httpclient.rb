...
class TestHTTPClient < Test::Unit::TestCase
  ...
  def test_proxy
    ...
    escape_noproxy do
      ...
      @client.proxy = "http://elm3ml:elm3ml@foo:1234"
      assert_equal(urify("http://elm3ml:elm3ml@foo:1234"), @client.proxy)
  ...
  def test_proxy_env
    setup_proxyserver
    escape_env do
      ENV['http_proxy'] = "http://elm3ml:elm3ml@foo:1234"
      ENV['NO_PROXY'] = "foobar"
  ...
  def test_proxy_env_cgi
    ...
    escape_env do
      ...
      ENV['CGI_HTTP_PROXY'] = "http://elm3ml:elm3ml@foo:1234"
      client = HTTPClient.new
      assert_equal(urify("http://elm3ml:elm3ml@foo:1234"), client.proxy)
    end
  end
...
EOS
      @client.debug_dev = str = ''
      @client.set_auth("http://www.example.org/baz/", 'elm3ml', 'elm3ml')
  ...
  def test_proxy_ssl
    escape_noproxy do
      @client.proxy = 'http://elm3ml:elm3ml@localhost:8080/'
